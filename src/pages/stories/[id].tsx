  ...
  return (
    <Fragment>
      ...
      <div className="flex flex-col flex-1 mb-8">
        <button
          className="px-2 py-1 bg-transparent rounded flex items-center mb-2 w-fit group hover:bg-hover cursor-pointer focus-visible:ring-1 focus-visible:ring-blue-500"
          onClick={onClickBack}
        >
        ...
        <div className="flex flex-col p-4 bg-primary border border-primary rounded">
          ...
          <div className="flex items-center justify-between mt-0.5">
            ...
            <button
              className="flex mr-2 p-1 w-fit items-center cursor-pointer rounded border-none hover:bg-hover focus-visible:ring-1 focus-visible:ring-blue-500"
              onClick={handleStar}
            >
              <StarIcon
                className={`h-3 w-3 ${
